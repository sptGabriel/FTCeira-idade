...
import { GetStudentsQuestionnaires } from '~/application/useCases/getQuestionnaire/get-no-answered-questionnaire.handler'

export class GetNotAnsweredQuestionnairesController implements IController {
  constructor(
  ...
  public async handle(
    req: RequestModel,
		...
		const useCase = container.resolve(GetStudentsQuestionnaires)
