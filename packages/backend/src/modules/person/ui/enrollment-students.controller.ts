...
import { EnrollmentStudentsHandler } from '~/application/useCases/enrollmentStudents/enrollment-students.handler'

export class EnrollmentStudentsController implements IController {
  constructor(
  ...
  public async handle(
    req: RequestModel,
		...
		const useCase = container.resolve(EnrollmentStudentsHandler)
