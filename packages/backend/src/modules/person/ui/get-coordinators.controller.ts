...
import { GetAllCoordinators } from '~/application/useCases/getCoordinator/get-coordinators.handler'

export class GetCoordinatorsController implements IController {
  constructor(
  ...
  public async handle(
    req: RequestModel,
		...
		const useCase = container.resolve(GetAllCoordinators)
